...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href=""> <img src="<?php echo BURL.'assets/images/logo.png' ?>" width="70" alt="LOGO"> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo BURLA.'index.php' ?>">Home <span class="sr-only">(current)</span></a>
                </li>
                ...
                <li class="nav-item">
                    <?php
                        if(isset($_SESSION['admin_name'])){ ?>
                            <a class="nav-link" href="<?php echo 'admins/handle-admin.php?action=logout' ?>">Logout</a>
                    <?php } else { ?>
